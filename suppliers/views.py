...
def home(request):
    ...
    return render(request, 'suppliers/home.html', context=context)
...
def cadastro_fornecedor(request):
    ...
    return render(request, 'suppliers/cadastro_fornecedor.html', {'form': form})
...
def cadastro_produto(request):
    ...
    return render(request, 'suppliers/cadastro_produto.html', {'form': form})
...
def cadastro_contrato(request, produto_id):
    ...
    return render(request, 'suppliers/cadastro_contrato.html', {'produto': produto})

def listagem_produtos(request):
    produtos = Produto.objects.all()
    return render(request, 'suppliers/listagem_produtos.html', {'produtos': produtos})

def detalhes_contrato(request, contrato_id):
    contrato = get_object_or_404(Contrato, id=contrato_id)
    valor_total = contrato.produto.valor_por_unidade * contrato.quantidade
    return render(request, 'suppliers/detalhes_contrato.html', {'contrato': contrato, 'valor_total': valor_total})
...
def listagem_contratos(request):
    ...
    return render(request, 'suppliers/listagem_contratos.html', {'contratos': contratos})
